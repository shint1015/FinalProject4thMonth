                    ...
                    <div className='divide-y divide-primary-white'>
                        {faqs.map((faq, i) => (
                            <div key={i} className='py-4'>
                                <button
                                    onClick={() => toggleFAQ(i)}
                                    className='w-full text-left text-primary-white text-body flex justify-between items-center'
                                >
                                    {faq.question}
                                    <img
                                ...
                                {openIndex === i && (
                                    <p className='mt-2 text-dark-gray text-detail'>{faq.answer}</p>
                                )}
                            </div>
                        ))}
                    </div>
                ...
                <div className='lg:w-[30%] w-full mb-[5rem]'>
                    ...
                    <form className='mt-4 flex flex-col gap-[1rem]'>
                        <input
                            type='text'
                            placeholder='Name'
                            className='bg-primary-white border-none placeholder-dark-grey text-black text-subbody focus:outline-none p-[1rem] rounded'
                        />
                        <input
                            type='text'
                            placeholder='Email'
                        ...
                        <textarea
                            type='text'
                            placeholder='Message'
                            className='bg-primary-white border-none placeholder-dark-grey text-black text-subbody focus:outline-none p-[1rem] rounded h-30 resize-none'
                        />
                        <button className='bg-primary-yellow text-black py-3 px-6 mt-4 rounded hover:bg-secondary-yellow text-subbody'>
                            Send
                        </button>
                    </form>
