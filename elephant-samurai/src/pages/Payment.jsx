                ...
                <div className='flex flex-col lg:flex-row gap-4'>
                    ...
                    <div className="flex flex-col justify-between">
                        ...
                        <div className="flex flex-row justify-between">
                            ...
                            <p className="text-body lg:text-detail text-primary-white">$5.99</p>
                        </div>
                        <div className="flex flex-row justify-between">
                            <p className="text-body lg:text-detail text-primary-white">Total</p>
                            <p className="text-body lg:text-detail text-primary-yellow">${(reservation.showPrice+5.99).toFixed(2)}</p>
                        </div>                                                      
                    </div>
                </div>
            </div>
            ...
            <div className="lg:w-[1/2]">
                ...
                onSubmit={(e) => { e.preventDefault(); GotoDashboard(); }}>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="NameEnter" className="bg-primary-white border-none placeholder-dark-grey text-black text-subbody focus:outline-none p-[1rem] rounded-[4px] w-full"/>
                    </div>
                    <div className="flex flex-row gap-4">
                        <div className="w-1/2">
                            <p className='text-subbody text-primary-white'>CVV Code</p>
                            <input type="tel" placeholder="CVV" className="bg-primary-white border-none placeholder-dark-grey text-black text-subbody focus:outline-none p-[1rem] rounded-[4px] w-full"/>
                        </div>
                        <div className="w-1/2">
